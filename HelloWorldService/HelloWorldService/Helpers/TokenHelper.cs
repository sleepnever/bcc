...
namespace HelloWorldService.Helpers
{
	public class Token
	{
	...
	public static class TokenHelper
	{
		...
		{
			// right here you'd do a db lookup to confirm the userName and password
			// if success and they're authenticated, then create the token to pass back
			var token = new Token
			{
				UserId = 10, // this would be set to the User's ID
